...
public class DirectedGraph<T> implements GraphInterface<T>
{
    ...
    public Queue<T> getDepthFirstTraversal(T origin)
    {
        ...
        vertexStack - new stack of visited vertices
        ...
        /*28.24
         ...
         while(!done && !priorityQueue.isEmpty())
         {
            ...
            if(frontVertex is not visited)
            {
                ...
                {
                    create iterator for neighbors
                    create iterator for weights

                    while(front index has a neighbor)
                    {
                        nextNeighbor = nextNeighbor of frontVertex
